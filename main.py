    ...
    def securityDefinitionOptionParameter(self, reqId: int, exchange: str, underlyingConId: int, tradingClass: str,
        ...
        for expiration in expirations:
            for strike in strikes:
                ...
                temp.multiplier = "100"
                time.sleep(1)
                tmper = app.reqHistoricalData(0, contract, "", "1 D", "1 min", "TRADES", 0, 1, False, [])
                time.sleep(1)
                print(tmper)
...
tmper = app.reqHistoricalData(5, contract, queryTime, "2 D", "4 hours", "TRADES", 1, 1, False, [])
# app.reqSecDefOptParams(0, "IBM", "", "STK", 8314)

time.sleep(5)
app.disconnect()
print("disconnected, now getting new data")
